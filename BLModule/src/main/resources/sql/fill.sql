use `contacts_list`;
insert into address(country, locality, street, house, apartment, postcode) values('Беларусь', 'Minsk', 'Могилевская', '34/2', null, '220014');
insert into contact(first_name, surname, patronymic, birth_date, sex, nationality, family_status, website, email, address_id)
values ("Kirill", "Karpuk", "Aleksandrovich", "1999/09/22", "male", "Belarus", "single", "https://vk.com/kirillkarpuk",
        "kirillkarpuk0@gmail.com", 1);
insert into address(country, locality, street, house, apartment, postcode) values('Украина', '', '', '', null, '');
...
insert into address(country, locality, street, house, apartment, postcode) values('Россия', 'Москва', '', '', null, '');
insert into contact(first_name, surname, patronymic, birth_date, sex, nationality, family_status, website, email,
                    current_workplace, address_id)
